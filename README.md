...
| [8B-distill](submissions/8B-distill/README.md) | TildeOpen8B-64k-wmt26-compression-task-cs-de | 8B | 16.3 GB | Distilled from TildeOpen15B-64k (Nvidia-NeMo) + GRPO | |
...
8B-distill model is distilled from the TildeOpen15B-64k model and finetuned; the quantized 8B variants are quantized from the resulting 8B-distill-finetune model. The quantized 15B variants are quantized directly from the baseline.
